...
@interface XBaseSettingViewController ()

@end



@implementation XBaseSettingViewController
...
//            NSLog(@"vc: %@", vc);
            ...
            if ([vc isKindOfClass:[XPushViewController class]]) {
                XPushViewController *pushVc = (XPushViewController *)vc;
